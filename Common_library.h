...
#define PERIOD_ALL 840//50 // Period of main loop
#define PERIOD_MA  5

#define PERIOD_PLC 500 // ms Period of PLC
// Total period(ms) = PERIOD_PLC * PERIOD_ALL

#define WAIT_TIME_HARDWARE 500
#define WAIT_TIME_HARDWARE_BENT 3000
#define WAIT_TIME_HARDWARE_REGULATION 500


#define WAIT_TIME_STABILIZATION 12000//180000//ms, need to notice for customers?
...
#define THR_PRESSURE_ALL_FIN_2_5 50.02f //100%
#define THR_PRESSURE_ALL_FIN_7_5 50.05f
